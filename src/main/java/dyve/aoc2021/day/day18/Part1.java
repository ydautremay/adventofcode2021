...
public class Part1 extends Part {
    ...
    public Object execute(InputReader inputReader) {
        ...
        String currentString = entries.get(0);
        for (int i = 1; i < entries.size(); i++){
            System.out.println(i + " : " + currentString);
            currentString = add(currentString, entries.get(i));
            currentString = reduce(currentString);
        }

        Operation operation = Operation.of(currentString, 0);
        return operation.magnitude();
//        String s = "[[[[4,0],[5,4]],[[7,0],[15,5]]],[10,[[11,9],[0,[11,8]]]]]";
//        return explode(s);
    }
